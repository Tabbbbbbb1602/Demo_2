...
public class EnemyManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        spawnPoint1 = Instantiate(spawnPoint, new Vector3(15, 8, 6), Quaternion.identity);
        spawnPoint2 = Instantiate(spawnPoint, new Vector3(28, 10, 12), Quaternion.identity);
        spawnPoint3 = Instantiate(spawnPoint, new Vector3(12, 16, 14), Quaternion.identity);
